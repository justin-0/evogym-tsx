        ...
        <div className="z-10 mt-32 md:basis-3/5">
          ...
          >
            <div className="relative ">
              <div className="before:absolute before:-left-20 before:-top-[4rem] before:z-[-1] md:before:content-evolvetext">
                <img src={HomePageText} alt="home-text" />
              </div>
            </div>
            <p className="mt-8 text-sm md:text-start">
              Unrivalled gym experience. Unmatched training classes. World class
              studios to achieve your fitness goals.
            </p>
          </motion.div>
          {/* Actions */}
          <motion.div
      ...
      {isAboveMdScreens && (
        <div className="h-[150px] w-full bg-primary-100 py-10">
          <div className="mx-auto w-5/6 ">
            <div className="flex items-center justify-center gap-80 md:gap-60">
